...
# Load Library and Display Options
def display_navigation():
    load_library()
    st.sidebar.markdown("<h1 style='text-align:center;'>Navigation</h1>", unsafe_allow_html=True)
    lottie_book = load_lottie_url("https://assets9.lottiefile.com/temp/1f20acAFIn.json")
    if lottie_book:
        with st.sidebar:
...
# Main Logic to Render the View Based on User's Selection
def main():
