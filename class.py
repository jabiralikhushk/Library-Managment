...
lottie_book = load_lottie_url("https://assets9.lottiefiles.com/temp/1f20acAFIn.json")
if lottie_book:
    ...
    if new_option == "View Library":
        st.session_state.current_view = "library"
    elif new_option == "Add Books":
        st.session_state.current_view = "add"
    elif new_option == "Search Books":
...
if st.session_state.current_view == "add":
    ...
    with st.form(key='add_book_form'):
        ...
        if submit_button and title and author:
            ...
            if st.session_state.books_added:
        ...
        for i, book in enumerate(st.session_state.library):
            with cols[i % 2]:
                ...
                with col2:
                    ...
                    status_label = "Mark as Unread" if book['read_status'] else "Mark as Read"
    ...
    search_by = st.selectbox("Search By:", ["title", "authors", "genre"])
    ...
    if search_term:
        with st.spinner("Searching..."):
            ...
            if st.session_state.search_results:
                ...
                st.markdown("<div class='warning-message'>No books found matching the search term.</div>", unsafe_allow_html=True)
